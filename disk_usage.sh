...
#how to call other script from your current script ----> sh <script-name>
sh mail.sh nandivamshikrishna@gmail.com "High Disk Usage" "$message" "DEVOPS TEAM" "High Disk Usage"